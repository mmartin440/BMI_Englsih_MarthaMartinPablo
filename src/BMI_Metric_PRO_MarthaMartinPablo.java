...
public class BMI_Metric_PRO_MarthaMartinPablo {
    public static void main(String[] args) {
        //intro at the Top
        System.out.println("-".repeat(90));
        System.out.println("-- Welcome to:");
        System.out.printf("%-13s %s%n", "--","BODY MASS INDEX (BMI) Computation, Metric version, PRO");
        ...
        // calculations for the BMI Metric version
